  ...
  return knex('podcasts').del()
    .then(function () {
      ...
      return knex('podcasts').insert([
          ...
          {id: 11, 
          title: 'Radiolab',
          image_URL: 'http://is1.mzstatic.com/image/thumb/Music127/v4/e2/e0/ea/e2e0ead8-a98b-788d-c384-cc4cdc01aaaf/source/600x600bb.jpg',
          ...
          rss_feed: 'http://feeds.wnyc.org/radiolab?format=xml',
          latest_pub_date: 'Jan 23, 2018',
